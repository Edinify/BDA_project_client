...
export const deletetBonusAction = ({_id, page, searchQuery, startDate, endDate}) => async (dispatch) => {
  try {
    await API.delete(`/${_id}`);
    dispatch({ type: BONUS_PAGINATION_ACTION_TYPE.DELETE_BONUS, payload: _id });
    dispatch(getBonusPaginationAction(page, searchQuery, startDate, endDate));
